...
function setInternalServerError($errno, $errstr, $errfile, $errorLine){
    ...
    echo '<span style="font-weit: bold; color:red">';
    switch($errno){
        case E_USER_ERROR:
            echo '<strong>ERROR</strong> [ ' . $errno . ' ]' . $errstr . "<br>\n";
            echo 'Fatal error on line ' . $errfile . ' in file ' . $errfile;
            break;
        case E_USER_WARNING:
